...
export var AttributeSuggestionsDescribeConfig = [
    3,
    n0,
    _ASDC,
    0,
...
export var AttributeSuggestionsGetConfig = [
    3,
    n0,
    _ASGC,
    0,
...
export var AttributeSuggestionsUpdateConfig = [
    3,
    n0,
    _ASUC,
    0,
...
export var BasicAuthenticationConfiguration = [3, n0, _BAC, 0, [_H, _Po, _C], [0, 1, 0]];
...
export var BatchDeleteFeaturedResultsSetError = [3, n0, _BDFRSE, 0, [_I, _EC, _EM], [0, 0, 0]];
export var BatchDeleteFeaturedResultsSetRequest = [3, n0, _BDFRSR, 0, [_II, _FRSI], [0, 64 | 0]];
export var BatchDeleteFeaturedResultsSetResponse = [
    3,
    n0,
    _BDFRSRa,
    0,
...
export var CapacityUnitsConfiguration = [3, n0, _CUC, 0, [_SCU, _QCU], [1, 1]];
export var ClearQuerySuggestionsRequest = [3, n0, _CQSR, 0, [_II], [0]];
export var ClickFeedback = [3, n0, _CF, 0, [_RI, _CTl], [0, 4]];
export var CollapseConfiguration = [
    3,
    n0,
    _CCo,
    0,
...
export var CollapsedResultDetail = [
    3,
    n0,
    _CRD,
    0,
...
export var Correction = [3, n0, _Co, 0, [_BO, _EO, _T, _CTo], [1, 1, 0, 0]];
...
export var CreateAccessControlConfigurationResponse = [3, n0, _CACCRr, 0, [_I], [0]];
...
export var CreateDataSourceResponse = [3, n0, _CDSRr, 0, [_I], [0]];
...
export var CreateExperienceResponse = [3, n0, _CERr, 0, [_I], [0]];
...
export var CreateFaqResponse = [3, n0, _CFRr, 0, [_I], [0]];
export var CreateFeaturedResultsSetRequest = [
    3,
    n0,
    _CFRSR,
    0,
...
export var CreateFeaturedResultsSetResponse = [
    3,
    n0,
    _CFRSRr,
    0,
...
export var CreateIndexResponse = [3, n0, _CIRr, 0, [_I], [0]];
...
export var CreateQuerySuggestionsBlockListResponse = [3, n0, _CQSBLRr, 0, [_I], [0]];
...
export var CreateThesaurusResponse = [3, n0, _CTRr, 0, [_I], [0]];
...
export var DataSourceGroup = [3, n0, _DSG, 0, [_GI, _DSI], [0, 0]];
...
export var DataSourceSyncJobMetricTarget = [3, n0, _DSSJMT, 0, [_DSI, _DSSJI], [0, 0]];
export var DataSourceToIndexFieldMapping = [3, n0, _DSTIFM, 0, [_DSFN, _DFF, _IFN], [0, 0, 0]];
export var DataSourceVpcConfiguration = [3, n0, _DSVC, 0, [_SIu, _SGI], [64 | 0, 64 | 0]];
export var DeleteAccessControlConfigurationRequest = [3, n0, _DACCR, 0, [_II, _I], [0, 0]];
export var DeleteAccessControlConfigurationResponse = [3, n0, _DACCRe, 0, [], []];
export var DeleteDataSourceRequest = [3, n0, _DDSR, 0, [_I, _II], [0, 0]];
export var DeleteExperienceRequest = [3, n0, _DER, 0, [_I, _II], [0, 0]];
export var DeleteExperienceResponse = [3, n0, _DERe, 0, [], []];
export var DeleteFaqRequest = [3, n0, _DFR, 0, [_I, _II], [0, 0]];
export var DeleteIndexRequest = [3, n0, _DIR, 0, [_I], [0]];
...
export var DeleteQuerySuggestionsBlockListRequest = [3, n0, _DQSBLR, 0, [_II, _I], [0, 0]];
export var DeleteThesaurusRequest = [3, n0, _DTR, 0, [_I, _II], [0, 0]];
export var DescribeAccessControlConfigurationRequest = [3, n0, _DACCRes, 0, [_II, _I], [0, 0]];
...
export var DescribeDataSourceRequest = [3, n0, _DDSRe, 0, [_I, _II], [0, 0]];
...
export var DescribeExperienceRequest = [3, n0, _DERes, 0, [_I, _II], [0, 0]];
...
export var DescribeFaqRequest = [3, n0, _DFRe, 0, [_I, _II], [0, 0]];
...
export var DescribeFeaturedResultsSetRequest = [3, n0, _DFRSR, 0, [_II, _FRSIe], [0, 0]];
export var DescribeFeaturedResultsSetResponse = [
    3,
    n0,
    _DFRSRe,
    0,
...
export var DescribeIndexRequest = [3, n0, _DIRe, 0, [_I], [0]];
...
export var DescribePrincipalMappingRequest = [3, n0, _DPMRe, 0, [_II, _DSI, _GI], [0, 0, 0]];
...
export var DescribeQuerySuggestionsBlockListRequest = [3, n0, _DQSBLRe, 0, [_II, _I], [0, 0]];
...
export var DescribeQuerySuggestionsConfigRequest = [3, n0, _DQSCR, 0, [_II], [0]];
...
export var DescribeThesaurusRequest = [3, n0, _DTRe, 0, [_I, _II], [0, 0]];
...
export var DocumentAttribute = [3, n0, _DA, 0, [_K, _V], [0, () => DocumentAttributeValue]];
...
export var DocumentAttributeValue = [3, n0, _DAV, 0, [_SV, _SLV, _LV, _DV], [0, 64 | 0, 1, 4]];
...
export var DocumentInfo = [3, n0, _DIo, 0, [_DI, _A], [0, () => DocumentAttributeList]];
...
export var DocumentRelevanceConfiguration = [3, n0, _DRC, 0, [_N, _R], [0, () => Relevance]];
export var DocumentsMetadataConfiguration = [3, n0, _DMCoc, 0, [_SPr], [0]];
export var EntityConfiguration = [3, n0, _ECn, 0, [_EInt, _ETnt], [0, 0]];
...
export var EntityPersonaConfiguration = [3, n0, _EPC, 0, [_EInt, _Pe], [0, 0]];
export var ExpandConfiguration = [3, n0, _ECx, 0, [_MRITE, _MERPI], [1, 1]];
export var ExpandedResultItem = [
    3,
    n0,
    _ERI,
    0,
...
export var ExperienceEndpoint = [3, n0, _EE, 0, [_ETnd, _End], [0, 0]];
...
export var Facet = [3, n0, _F, 0, [_DAK, _Fa, _MR], [0, () => FacetList, 1]];
...
export var FailedEntity = [3, n0, _FE, 0, [_EInt, _EM], [0, 0]];
export var FaqStatistics = [3, n0, _FS, 0, [_IQAC], [1]];
...
export var FeaturedDocument = [3, n0, _FDea, 0, [_I], [0]];
export var FeaturedDocumentMissing = [3, n0, _FDMe, 0, [_I], [0]];
export var FeaturedDocumentWithMetadata = [3, n0, _FDWMe, 0, [_I, _Ti, _URI], [0, 0, 0]];
export var FeaturedResultsConflictException = [
    -3,
    n0,
    _FRCE,
    {
...
export var FeaturedResultsItem = [
    3,
    n0,
    _FRI,
    0,
...
export var FeaturedResultsSetSummary = [
    3,
    n0,
    _FRSS,
    0,
...
export var GetSnapshotsRequest = [3, n0, _GSR, 0, [_II, _In, _MT, _NTe, _MR], [0, 0, 0, 0, 1]];
...
export var GroupSummary = [3, n0, _GS, 0, [_GI, _OI], [0, 1]];
export var HierarchicalPrincipal = [3, n0, _HP, 0, [_PL], [() => PrincipalList]];
export var Highlight = [3, n0, _Hi, 0, [_BO, _EO, _TA, _Ty], [1, 1, 2, 0]];
...
export var JsonTokenTypeConfiguration = [3, n0, _JTTC, 0, [_UNAF, _GAF], [0, 0]];
...
export var ListDataSourcesRequest = [3, n0, _LDSR, 0, [_II, _NTe, _MR], [0, 0, 1]];
...
export var ListEntityPersonasRequest = [3, n0, _LEPR, 0, [_I, _II, _NTe, _MR], [0, 0, 0, 1]];
...
export var ListExperienceEntitiesRequest = [3, n0, _LEER, 0, [_I, _II, _NTe], [0, 0, 0]];
...
export var ListExperiencesRequest = [3, n0, _LER, 0, [_II, _NTe, _MR], [0, 0, 1]];
...
export var ListFaqsRequest = [3, n0, _LFR, 0, [_II, _NTe, _MR], [0, 0, 1]];
export var ListFaqsResponse = [3, n0, _LFRi, 0, [_NTe, _FSIa], [0, () => FaqSummaryItems]];
export var ListFeaturedResultsSetsRequest = [3, n0, _LFRSR, 0, [_II, _NTe, _MR], [0, 0, 1]];
export var ListFeaturedResultsSetsResponse = [
    3,
    n0,
    _LFRSRi,
    0,
...
export var ListIndicesRequest = [3, n0, _LIR, 0, [_NTe, _MR], [0, 1]];
...
export var ListThesauriRequest = [3, n0, _LTR, 0, [_II, _NTe, _MR], [0, 0, 1]];
...
export var MemberGroup = [3, n0, _MGe, 0, [_GI, _DSI], [0, 0]];
export var MemberUser = [3, n0, _MUe, 0, [_UI], [0]];
...
export var OneDriveUsers = [3, n0, _ODU, 0, [_ODUL, _ODUSP], [64 | 0, () => S3Path]];
export var OnPremiseConfiguration = [3, n0, _OPC, 0, [_HU, _ON, _SCSP], [0, 0, () => S3Path]];
export var PersonasSummary = [3, n0, _PS, 0, [_EInt, _Pe, _CAre, _UA], [0, 0, 4, 4]];
export var Principal = [3, n0, _Pri, 0, [_N, _Ty, _Ac, _DSI], [0, 0, 0, 0]];
export var ProxyConfiguration = [3, n0, _PCr, 0, [_H, _Po, _C], [0, 1, 0]];
...
export var RetrieveResult = [3, n0, _RRe, 0, [_QI, _RIe], [0, () => RetrieveResultItemList]];
export var RetrieveResultItem = [
    3,
    n0,
    _RRI,
    0,
...
export var S3Path = [3, n0, _SP, 0, [_Bu, _K], [0, 0]];
export var SaaSConfiguration = [3, n0, _SSC, 0, [_ON, _HU], [0, 0]];
...
export var ScoreAttributes = [3, n0, _SAc, 0, [_SCc], [0]];
export var Search = [3, n0, _Se, 0, [_Fac, _Sea, _Di, _So], [2, 2, 2, 2]];
export var SeedUrlConfiguration = [3, n0, _SUC, 0, [_SUee, _WCM], [64 | 0, 0]];
export var ServerSideEncryptionConfiguration = [3, n0, _SSEC, 0, [_KKI], [[() => KmsKeyId, 0]]];
...
export var SiteMapsConfiguration = [3, n0, _SMC, 0, [_SM], [64 | 0]];
...
export var SortingConfiguration = [3, n0, _SCor, 0, [_DAK, _SO], [0, 0]];
export var SourceDocument = [
    3,
    n0,
    _SDo,
    0,
...
export var SpellCorrectedQuery = [3, n0, _SCQp, 0, [_SQT, _Cor], [0, () => CorrectionList]];
export var SpellCorrectionConfiguration = [3, n0, _SCC, 0, [_IQSCS], [2]];
export var SqlConfiguration = [3, n0, _SCq, 0, [_QIEO], [0]];
export var StartDataSourceSyncJobRequest = [3, n0, _SDSSJR, 0, [_I, _II], [0, 0]];
export var StartDataSourceSyncJobResponse = [3, n0, _SDSSJRt, 0, [_EIx], [0]];
export var Status = [3, n0, _St, 0, [_DI, _DSo, _FCa, _FRai], [0, 0, 0, 0]];
export var StopDataSourceSyncJobRequest = [3, n0, _SDSSJRto, 0, [_I, _II], [0, 0]];
...
export var SuggestableConfig = [3, n0, _SCu, 0, [_AN, _Sug], [0, 2]];
...
export var SuggestionHighlight = [3, n0, _SH, 0, [_BO, _EO], [1, 1]];
...
export var SuggestionValue = [3, n0, _SVu, 0, [_Te], [() => SuggestionTextWithHighlights]];
export var TableCell = [3, n0, _TCa, 0, [_V, _TA, _High, _He], [0, 2, 2, 2]];
export var TableExcerpt = [3, n0, _TE, 0, [_Ro, _TNORo], [() => TableRowList, 1]];
export var TableRow = [3, n0, _TR, 0, [_Ce], [() => TableCellList]];
export var Tag = [3, n0, _Tag, 0, [_K, _V], [0, 0]];
export var TagResourceRequest = [3, n0, _TRR, 0, [_RARN, _Ta], [0, () => TagList]];
export var TagResourceResponse = [3, n0, _TRRa, 0, [], []];
export var TemplateConfiguration = [3, n0, _TC, 0, [_Tem], [15]];
...
export var UpdateAccessControlConfigurationResponse = [3, n0, _UACCRp, 0, [], []];
...
export var UpdateFeaturedResultsSetRequest = [
    3,
    n0,
    _UFRSR,
    0,
...
export var UpdateFeaturedResultsSetResponse = [
    3,
    n0,
    _UFRSRp,
    0,
...
export var UserGroupResolutionConfiguration = [3, n0, _UGRC, 0, [_UGRM], [0]];
export var UserIdentityConfiguration = [3, n0, _UIC, 0, [_IAN], [0]];
...
export var KendraServiceException = [-3, _sm, "KendraServiceException", 0, [], []];
TypeRegistry.for(_sm).registerError(KendraServiceException, __KendraServiceException);
export var AccessControlConfigurationSummaryList = [
    1,
    n0,
    _ACCSL,
    0,
...
export var AdditionalResultAttributeList = [1, n0, _ARAL, 0, () => AdditionalResultAttribute];
export var AssociateEntitiesToExperienceFailedEntityList = [1, n0, _AETEFEL, 0, () => FailedEntity];
export var AssociateEntityList = [1, n0, _AEL, 0, () => EntityConfiguration];
export var AttributeFilterList = [1, n0, _AFL, 0, () => AttributeFilter];
export var BasicAuthenticationConfigurationList = [
    1,
    n0,
    _BACL,
    0,
...
export var BatchDeleteDocumentResponseFailedDocuments = [
    1,
    n0,
    _BDDRFDa,
    0,
...
export var BatchDeleteFeaturedResultsSetErrors = [
    1,
    n0,
    _BDFRSEa,
    0,
...
export var BatchGetDocumentStatusResponseErrors = [
    1,
    n0,
    _BGDSREa,
    0,
...
export var BatchPutDocumentResponseFailedDocuments = [
    1,
    n0,
    _BPDRFDa,
    0,
...
export var ClickFeedbackList = [1, n0, _CFL, 0, () => ClickFeedback];
export var ConflictingItems = [1, n0, _CIo, 0, () => ConflictingItem];
export var ConfluenceAttachmentFieldMappingsList = [
    1,
    n0,
    _CAFML,
    0,
...
export var ConfluenceBlogFieldMappingsList = [
    1,
    n0,
    _CBFML,
    0,
...
export var ConfluencePageFieldMappingsList = [
    1,
    n0,
    _CPFML,
    0,
...
export var ConfluenceSpaceFieldMappingsList = [
    1,
    n0,
    _CSFML,
    0,
...
export var CorrectionList = [1, n0, _CL, 0, () => Correction];
export var DataSourceGroups = [1, n0, _DSGa, 0, () => DataSourceGroup];
export var DataSourceIdList = 64 | 0;
export var DataSourceInclusionsExclusionsStrings = 64 | 0;
export var DataSourceSummaryList = [1, n0, _DSSL, 0, () => DataSourceSummary];
export var DataSourceSyncJobHistoryList = [1, n0, _DSSJHL, 0, () => DataSourceSyncJob];
export var DataSourceToIndexFieldMappingList = [
    1,
    n0,
    _DSTIFML,
    0,
...
export var DisassociateEntityList = [1, n0, _DEL, 0, () => EntityConfiguration];
export var DocumentAttributeKeyList = 64 | 0;
export var DocumentAttributeList = [1, n0, _DAL, 0, () => DocumentAttribute];
export var DocumentAttributeStringListValue = 64 | 0;
export var DocumentAttributeValueCountPairList = [
    1,
    n0,
    _DAVCPL,
    0,
...
export var DocumentInfoList = [1, n0, _DILo, 0, () => DocumentInfo];
export var DocumentList = [1, n0, _DL, 0, () => Document];
export var DocumentMetadataConfigurationList = [1, n0, _DMCL, 0, () => DocumentMetadataConfiguration];
export var DocumentRelevanceOverrideConfigurationList = [
    1,
    n0,
    _DROCL,
    0,
...
export var DocumentStatusList = [1, n0, _DSL, 0, () => Status];
export var EntityFilter = 64 | 0;
export var EntityIdsList = 64 | 0;
export var EntityPersonaConfigurationList = [1, n0, _EPCL, 0, () => EntityPersonaConfiguration];
export var ExcludeMimeTypesList = 64 | 0;
export var ExcludeSharedDrivesList = 64 | 0;
export var ExcludeUserAccountsList = 64 | 0;
export var ExpandedResultList = [1, n0, _ERL, 0, () => ExpandedResultItem];
export var ExperienceEndpoints = [1, n0, _EEx, 0, () => ExperienceEndpoint];
export var ExperienceEntitiesSummaryList = [1, n0, _EESL, 0, [() => ExperienceEntitiesSummary, 0]];
export var ExperiencesSummaryList = [1, n0, _ESL, 0, () => ExperiencesSummary];
export var FacetList = [1, n0, _FL, 0, () => Facet];
export var FacetResultList = [1, n0, _FRL, 0, () => FacetResult];
export var FailedEntityList = [1, n0, _FEL, 0, () => FailedEntity];
export var FaqIdsList = 64 | 0;
export var FaqSummaryItems = [1, n0, _FSIa, 0, () => FaqSummary];
export var FeaturedDocumentList = [1, n0, _FDL, 0, () => FeaturedDocument];
export var FeaturedDocumentMissingList = [1, n0, _FDML, 0, () => FeaturedDocumentMissing];
export var FeaturedDocumentWithMetadataList = [1, n0, _FDWML, 0, () => FeaturedDocumentWithMetadata];
export var FeaturedResultsItemList = [1, n0, _FRIL, 0, () => FeaturedResultsItem];
export var FeaturedResultsSetIdList = 64 | 0;
export var FeaturedResultsSetSummaryItems = [1, n0, _FRSSI, 0, () => FeaturedResultsSetSummary];
export var FolderIdList = 64 | 0;
export var GroupOrderingIdSummaries = [1, n0, _GOIS, 0, () => GroupOrderingIdSummary];
export var Groups = 64 | 0;
export var HierarchicalPrincipalList = [1, n0, _HPL, 0, () => HierarchicalPrincipal];
export var HighlightList = [1, n0, _HL, 0, () => Highlight];
export var IndexConfigurationSummaryList = [1, n0, _ICSL, 0, () => IndexConfigurationSummary];
export var InlineCustomDocumentEnrichmentConfigurationList = [
    1,
    n0,
    _ICDECL,
    0,
...
export var ListOfGroupSummaries = [1, n0, _LOGS, 0, () => GroupSummary];
export var MemberGroups = [1, n0, _MG, 0, () => MemberGroup];
export var MemberUsers = [1, n0, _MU, 0, () => MemberUser];
export var OneDriveUserList = 64 | 0;
export var PersonasSummaryList = [1, n0, _PSL, 0, () => PersonasSummary];
...
export var QueryResultItemList = [1, n0, _QRIL, 0, () => QueryResultItem];
export var QuerySuggestionsBlockListSummaryItems = [
    1,
    n0,
    _QSBLSI,
    0,
...
export var RelevanceFeedbackList = [1, n0, _RFL, 0, () => RelevanceFeedback];
export var RepositoryNames = 64 | 0;
export var RetrieveResultItemList = [1, n0, _RRIL, 0, () => RetrieveResultItem];
export var SalesforceChatterFeedIncludeFilterTypes = 64 | 0;
export var SalesforceCustomKnowledgeArticleTypeConfigurationList = [
    1,
    n0,
    _SCKATCL,
    0,
...
export var SalesforceStandardObjectConfigurationList = [
    1,
    n0,
    _SSOCL,
    0,
...
export var SnapshotsDataRecords = [1, n0, _SDR, 0, 64 | 0];
export var SortingConfigurationList = [1, n0, _SCLo, 0, () => SortingConfiguration];
export var SourceDocuments = [1, n0, _SDou, 0, () => SourceDocument];
export var SpellCorrectedQueryList = [1, n0, _SCQL, 0, () => SpellCorrectedQuery];
export var StringList = 64 | 0;
export var SubnetIdList = 64 | 0;
export var SuggestableConfigList = [1, n0, _SCL, 0, () => SuggestableConfig];
export var SuggestionHighlightList = [1, n0, _SHL, 0, () => SuggestionHighlight];
export var SuggestionList = [1, n0, _SL, 0, () => Suggestion];
export var SuggestionTypes = 64 | 0;
export var TableCellList = [1, n0, _TCL, 0, () => TableCell];
export var TableRowList = [1, n0, _TRL, 0, () => TableRow];
export var TagKeyList = 64 | 0;
export var TagList = [1, n0, _TL, 0, () => Tag];
export var ThesaurusSummaryItems = [1, n0, _TSI, 0, () => ThesaurusSummary];
export var UserTokenConfigurationList = [1, n0, _UTCL, 0, () => UserTokenConfiguration];
export var WarningList = [1, n0, _WL, 0, () => Warning];
export var ValueImportanceMap = 128 | 1;
export var AssociateEntitiesToExperience = [
    9,
    n0,
    _AETE,
    0,
...
export var AssociatePersonasToEntities = [
    9,
    n0,
    _APTE,
    0,
...
export var BatchDeleteFeaturedResultsSet = [
    9,
    n0,
    _BDFRS,
    0,
...
export var BatchGetDocumentStatus = [
    9,
    n0,
    _BGDS,
    0,
...
export var ClearQuerySuggestions = [
    9,
    n0,
    _CQS,
    0,
...
export var CreateAccessControlConfiguration = [
    9,
    n0,
    _CACC,
    0,
...
export var CreateFaq = [9, n0, _CFr, 0, () => CreateFaqRequest, () => CreateFaqResponse];
export var CreateFeaturedResultsSet = [
    9,
    n0,
    _CFRS,
    0,
...
export var CreateIndex = [9, n0, _CIre, 0, () => CreateIndexRequest, () => CreateIndexResponse];
export var CreateQuerySuggestionsBlockList = [
    9,
    n0,
    _CQSBL,
    0,
...
export var DeleteAccessControlConfiguration = [
    9,
    n0,
    _DACC,
    0,
...
export var DeleteDataSource = [9, n0, _DDS, 0, () => DeleteDataSourceRequest, () => __Unit];
export var DeleteExperience = [
    9,
    n0,
    _DEe,
    0,
...
export var DeleteFaq = [9, n0, _DFe, 0, () => DeleteFaqRequest, () => __Unit];
export var DeleteIndex = [9, n0, _DIe, 0, () => DeleteIndexRequest, () => __Unit];
export var DeletePrincipalMapping = [
    9,
    n0,
    _DPM,
    0,
...
export var DeleteQuerySuggestionsBlockList = [
    9,
    n0,
    _DQSBL,
    0,
...
export var DeleteThesaurus = [9, n0, _DTe, 0, () => DeleteThesaurusRequest, () => __Unit];
export var DescribeAccessControlConfiguration = [
    9,
    n0,
    _DACCe,
    0,
...
export var DescribeFaq = [9, n0, _DFes, 0, () => DescribeFaqRequest, () => DescribeFaqResponse];
export var DescribeFeaturedResultsSet = [
    9,
    n0,
    _DFRS,
    0,
...
export var DescribePrincipalMapping = [
    9,
    n0,
    _DPMe,
    0,
...
export var DescribeQuerySuggestionsBlockList = [
    9,
    n0,
    _DQSBLe,
    0,
...
export var DescribeQuerySuggestionsConfig = [
    9,
    n0,
    _DQSC,
    0,
...
export var DisassociateEntitiesFromExperience = [
    9,
    n0,
    _DEFE,
    0,
...
export var DisassociatePersonasFromEntities = [
    9,
    n0,
    _DPFE,
    0,
...
export var GetQuerySuggestions = [
    9,
    n0,
    _GQS,
    0,
...
export var ListAccessControlConfigurations = [
    9,
    n0,
    _LACC,
    0,
...
export var ListExperienceEntities = [
    9,
    n0,
    _LEE,
    0,
...
export var ListFaqs = [9, n0, _LF, 0, () => ListFaqsRequest, () => ListFaqsResponse];
export var ListFeaturedResultsSets = [
    9,
    n0,
    _LFRS,
    0,
...
export var ListGroupsOlderThanOrderingId = [
    9,
    n0,
    _LGOTOI,
    0,
...
export var ListIndices = [9, n0, _LI, 0, () => ListIndicesRequest, () => ListIndicesResponse];
export var ListQuerySuggestionsBlockLists = [
    9,
    n0,
    _LQSBL,
    0,
...
export var PutPrincipalMapping = [
    9,
    n0,
    _PPM,
    0,
...
export var Query = [9, n0, _Q, 0, () => QueryRequest, () => QueryResult];
export var Retrieve = [9, n0, _Re, 0, () => RetrieveRequest, () => RetrieveResult];
...
export var SubmitFeedback = [9, n0, _SFu, 0, () => SubmitFeedbackRequest, () => __Unit];
...
export var UpdateAccessControlConfiguration = [
    9,
    n0,
    _UACC,
    0,
...
export var UpdateDataSource = [9, n0, _UDS, 0, () => UpdateDataSourceRequest, () => __Unit];
export var UpdateExperience = [9, n0, _UE, 0, () => UpdateExperienceRequest, () => __Unit];
export var UpdateFeaturedResultsSet = [
    9,
    n0,
    _UFRS,
    0,
...
export var UpdateIndex = [9, n0, _UIp, 0, () => UpdateIndexRequest, () => __Unit];
export var UpdateQuerySuggestionsBlockList = [
    9,
    n0,
    _UQSBL,
    0,
...
export var UpdateQuerySuggestionsConfig = [
    9,
    n0,
    _UQSC,
    0,
...
export var UpdateThesaurus = [9, n0, _UT, 0, () => UpdateThesaurusRequest, () => __Unit];
